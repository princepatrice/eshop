...
//import TextPublication from 'App/Models/TextPublication';
...
export default class extends BaseSeeder {
  public async run() {
    try {
      ...
      await workbook.xlsx.readFile('database/seeders/Purchaseing_info_Dataset.xlsx')
      ...
      for (let key in manufacturerList) {
        ...
        let itemsSaved = await Item.createMany(items)
